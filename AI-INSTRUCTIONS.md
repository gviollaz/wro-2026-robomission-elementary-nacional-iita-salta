...
# Herramienta: [IA: nombre y modelo exacto | "Codigo escrito manualmente"]
...
1. **OBLIGATORIO** en todo archivo de codigo. Sin header, no se acepta el PR.
2. El **Autor** es siempre la persona humana, nunca la IA.
3. La **Herramienta** debe ser especifica: "Claude Opus 4.6", "ChatGPT 4o", etc.
4. La **Fecha** incluye hora para rastrear versiones del mismo dia.
5. Al modificar un archivo existente, actualizar la **Rev** y la **Fecha**.
